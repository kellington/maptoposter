...
This is an open-source project that I want to customize and use to create maps of all the places that Lucie and I vacation.

## The AI Approach
*The practical reasons AI tools or agents were included in this project.*

Just use AI to help tweak the code/config to get the images I want
